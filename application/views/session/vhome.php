						...
						<form action="<?= base_url() ?>cpeminjaman/form/add_save" method="post" id="form_sample_1" class="form-horizontal">
							<div class="form-body">
								<div class="form-group row">
									<label class="control-label col-md-3">Peminjam
										...
										<select class="form-control select2" name="buku_id">
											<?php foreach ($qbuku as $rb) {
												if ($rb->buku_id == $buku_id || $rb->jumlah > 0) {
													echo "<option value=" . $rb->buku_id . " selected>Sisa " . $rb->jumlah . ' - ' . $rb->judul . ' [' . $rb->kode_buku . ']' . "</option>";
												}
											}
											?>
										</select>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" name="jumlah_pinjam" placeholder="Jumlah" value="" class="form-control input-height" required /> </div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" name="ket_pinjam" placeholder="Keterangan Peminjaman (Tidak Wajib)" value="" class="form-control input-height" /> </div>
								</div>
